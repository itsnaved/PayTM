        ...
        <div className="h-full flex flex-col justify-center">
            ...
            >
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <h3 class="text-2xl font-semibold">Naved Shaikh</h3>
                </div>
                <div class="space-y-4">
                    <div class="space-y-2">
                    <label
                    ...
                    <input
                        type="number"
                        class="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm outline-none border-slate-300"
                        id="amount"
